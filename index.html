...
<html lang="en-US">
  <head>
    ...
    <title>Mayank Kudale Profile</title>
    ...
    <header>
      <div class="profile-page sidebar-collapse">
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
          <div class="container">
            <div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip">Mayank Kudale</a>
    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="images/mayank_img.jpg" alt="Image"/></a></div>
          <div class="h2 title">Mayank Kudale</div>
          <p class="category text-white">Full Stack Developer</p><a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Hire Me</a><a class="btn btn-primary" href="#" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Download CV</a>
        </div>
      </div>
      <div class="section">
        <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>Hello! I am Mayank Kudale. I have 6+ years of experience in Software Development.</p>
            <p>Hands on experience in application development using C#, ASP.NET, WCF, LINQ, ADO.NET ,Angular 2, Silverlight, jQuery, HTML, XML,JSON, AJAX, CSS.<br>
Experience in developing Web Services using - SOAP, WSDL and RESTful Web Services.<br>
Experience on Cloud Computing platform like Azure.<br>
Proficient in database development: MySQL, MS SQL.<br>
Proficient in front end technologies: JavaScript, jQuery, Silverlight, XAML, HTML, CSS.<br>
Good at Data Structures and Algorithms : Solved many algorithmic problems on codechef.com<br>
Experience in Software development and business modeling in Web applications, Client/Server systems, Distributed
Applications and Windows Environments.</a></p>
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">mayank.kudale@gmail.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <div class="col-sm-8">+91 8087563808</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
              <div class="col-sm-8">Pune, India</div>
            </div>
            <div class="row mt-3">
  ...
  <div class="container">
    ...
    <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Algorithms and Data Structure</span>
              <div class="progress">
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Programming Languages : C#, C, Java, Python</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="95" style="width: 100%;"></div><span class="progress-value">95%</span>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Frameworks: MVC.NET, WEB API (.NET)</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"></div><span class="progress-value">90%</span>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Frontend technologies: JavaScript, JQuery,<br> Angular2, Silverlight, XAML, CSS and HTML  </span>
              <div class="progress">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Database Technologies: MySQL, SQL Server, ADO.NET</span>
              <div class="progress">
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Agile Methodology: Scrum</span>
              <div class="progress">
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            ...
            <div class="h5">Wolters Kluwer Pvt.Ltd</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Senior Software Engineer</div>
            <p>Working on CCH-iFirm product- a Tax and Accounting product. <br>
			About CCH iFirm :CCH iFirm is an award-winning practice management software ecosystem built around a centralized client database that helps accounting professionals serve their clients and manage their practice.<br>

CCH iFirm is cloud-based software that helps you integrate, monitor and streamline all the key facets of your business. CCH iFirm delivers the power of integration, automation and collaboration to create new opportunities for streamlined workflow, as well as for the implementation of more effective invoicing programs and better capacity planning without increased costs. CCH iFirm is trusted by more than 400 CA firms in India and South Asia.</p>
    <br>
	Responsibilties: Product was built in Silverlight Technology a legacy technology. Our main focus is on converting silverlight pages into Angular pages. Apart from UI screen rebuild, I am working on rollover/compliance changes for Tax system, solving existing critical issues of product.
          </div>
        </div>
      </div>
    </div>
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <p>July 2014 - October 2017</p>
            <div class="h5">Harbinger Systems Pvt. Ltd.</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Senior Product Software Engineer</div>
            <p>Skype for business based smart global helpdesk application available to all Microsoft employees across multiple
countries. Application resides in contextual window of Skype for Business. User can seek for help through this
application. Application supports NLP (Natural Language Processing) to resolve the users’ problems. System also
provides Chat and Call functionalities which enables users to communicate with agent who in turn addresses there
queries.</p>
          </div>
        </div>
      </div>
  ...
  <div class="container cc-education">
      ...
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            ...
            <p class="category">University of Pune</p>
            <p>Passed with First Class</p>
          </div>
        </div>
      </div>
    </div>
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Information Technology</div>
            <p class="category">Governement Polytechnic Pune</p>
            <p>Passed with First Class and Distinction.</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="section" id="contact">
  <div class="cc-contact-information" style="background-image: url('images/staticmap.jpg');">
    <div class="container">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="card-body">
                    <form action="https://formspree.io/your@email.com" method="POST">
                      ...
                      <div class="row">
                        <div class="col">
                          <button class="btn btn-primary" type="submit">Comming soon..</button>
                        </div>
                      </div>
                    </form>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <p class="pb-2">Pune, Maharashtra, India</p>
                    <p class="mb-0"><strong>Phone</strong></p>
                    <p class="pb-2">+91 8087563808</p>
                    <p class="mb-0"><strong>Email</strong></p>
                    <p>mayank.kudale@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <footer class="footer">
      ...
      <div class="h4 title text-center">Mayank Kudale</div>
